  ...
  Compute(lmp, iarg, narg, arg)
{
  ...
  for (; iarg < narg; iarg++) {
    ...
    else if (strcmp(arg[iarg],"bEfn") == 0)
      pack_choice[i] = &ComputePropertyLocal::pack_bEfn;
    else if (strcmp(arg[iarg],"bEft") == 0)
      pack_choice[i] = &ComputePropertyLocal::pack_bEft;
    else if (strcmp(arg[iarg],"bEtn") == 0)
      pack_choice[i] = &ComputePropertyLocal::pack_bEtn;
    else if (strcmp(arg[iarg],"bEtt") == 0)
      pack_choice[i] = &ComputePropertyLocal::pack_bEtt;
...
void ComputePropertyLocal::pack_batom1x(int n)
{
  int i,j;
  double **pos = atom->x;
...
void ComputePropertyLocal::pack_batom1y(int n)
{
  int i,j;
  double **pos = atom->x;
...
void ComputePropertyLocal::pack_batom1z(int n)
{
  int i,j;
  double **pos = atom->x;
...
void ComputePropertyLocal::pack_batom2x(int n)
{
  int i,j;
  double **pos = atom->x;
  int **bond_atom = atom->bond_atom;
  ...
  for (int m = 0; m < ncount; m++) {
    i = indices[m][0];
    j = indices[m][1];
    partner=bond_atom[i][j]; //ID !
    buf[n] = pos[atom->map(partner)][0]; //index
    n += nvalues;
  }
}
...
void ComputePropertyLocal::pack_batom2y(int n)
{
  int i,j;
  double **pos = atom->x;
  int **bond_atom = atom->bond_atom;
  ...
  for (int m = 0; m < ncount; m++) {
    ...
    j = indices[m][1];
    partner=bond_atom[i][j]; //ID !
    buf[n] = pos[atom->map(partner)][1]; //index
    n += nvalues;
  }
}
...
void ComputePropertyLocal::pack_batom2z(int n)
{
  int i,j;
  double **pos = atom->x;
  int **bond_atom = atom->bond_atom;
  ...
  for (int m = 0; m < ncount; m++) {
    ...
    j = indices[m][1];
    partner=bond_atom[i][j]; //ID !
    buf[n] = pos[atom->map(partner)][2]; //index
    n += nvalues;
  }
}
    ...
    if (atom2<0) continue; //is not on this proc, no Idea how to handle this ..
     ...
     for (k = 0; k < nbondlist; k++) {
        ...
        if (((atom1==i1) && (atom2==j1)) || ((atom1==j1) && (atom2==i1))) {
            f=bondhistlist[k][0] + bondhistlist[k][3];
            break;
        }
     }
    buf[n] = f;
  ...
  for (int m = 0; m < ncount; m++) {
    ...
    if (atom2<0) continue; //is not on this proc, no Idea how to handle this ..
     ...
     for (k = 0; k < nbondlist; k++) {
        ...
        //printf("|-> i1=%d,j1=%d",atom1,atom2);
        if (((atom1==i1) && (atom2==j1)) || ((atom1==j1) && (atom2==i1))) {
            f=bondhistlist[k][1] + bondhistlist[k][4];
            break;
        }
     }
    buf[n] = f;
  ...
  for (int m = 0; m < ncount; m++) {
    ...
    if (atom2<0) continue; //is not on this proc, no Idea how to handle this ..
     ...
     for (k = 0; k < nbondlist; k++) {
        ...
        //printf("|-> i1=%d,j1=%d",atom1,atom2);
        if (((atom1==i1) && (atom2==j1)) || ((atom1==j1) && (atom2==i1))) {
            f=bondhistlist[k][2] + bondhistlist[k][5];
            break;
        }
     }
    buf[n] = f;
...
void ComputePropertyLocal::pack_bEfn(int n)
{
  int i,j,k,i1,j1,atom1,atom2;
  double t = 0.0;
  int nbondlist = neighbor->nbondlist;
...
void ComputePropertyLocal::pack_bEft(int n)
{
  int i,j,k,i1,j1,atom1,atom2;
  double t = 0.0;
  int nbondlist = neighbor->nbondlist;
...
void ComputePropertyLocal::pack_bEtn(int n)
{
  int i,j,k,i1,j1,atom1,atom2;
  double t = 0.0;
  int nbondlist = neighbor->nbondlist;
...
void ComputePropertyLocal::pack_bEtt(int n)
{
  int i,j,k,i1,j1,atom1,atom2;
  double t = 0.0;
  int nbondlist = neighbor->nbondlist;
