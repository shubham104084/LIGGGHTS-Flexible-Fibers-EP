========================================================================
    ANWENDUNG: HOTINT_Log-Projektübersicht
========================================================================

Diese HOTINT_Log-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.  

Diese Datei enthält eine Zusammenfassung dessen, was Sie in jeder der Dateien
finden, aus denen Ihre HOTINT_Log-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "HOTINT_Log.pch und eine 
